...
public class Appointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsertData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String imgurl = fAuth.getCurrentUser().getPhotoUrl()!=null? fAuth.getCurrentUser().getPhotoUrl().toString() : null;
                ...
                if(barber.equals("Select a Barber")){
                    Toast.makeText(Appointment.this,"Select a Barber",Toast.LENGTH_SHORT).show();
                }
                else
                    saveToFirestore(id,date,time,barber,name,imgurl);
                }
        });
    ...
    private void saveToFirestore(String id, String date,String time, String barber,String name,String imgurl){
